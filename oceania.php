...
<head>
    ...
    <title>Oceania | Country Panel</title>
...
<body>
      ...
      <section>
        <div class="main_quiz left">
          <div class="question row">
            <div class="col-lg-9">
                <h5>1. Canberra is the capital of?</h5>  
                </div>
                <div class="col-lg-3">
          ...
          <div class="options_list">
            <div class="option">
                <label for="Australia" class="radio">
                    <input type="radio" name="list" id="Australia" class="radio__input" value="Australia">
                    <div class="radio__radio"></div>
                    Australia
                </label>
            </div>
            <div class="option">
                <label for="Solomon Islands" class="radio">
                    <input type="radio" name="list" id="Solomon Islands" class="radio__input" value="Solomon Islands">
                    <div class="radio__radio"></div>
                    Solomon Islands
                </label>
            </div>
            <div class="option">
                <label for="Kiribati" class="radio">
                    <input type="radio" name="list" id="Kiribati" class="radio__input" value="Kiribati">
                    <div class="radio__radio"></div>
                    Kiribati
                </label>
            </div>
            <div class="option">
                <label for="Ghana" class="radio">
                    <input type="radio" name="list" id="Ghana" class="radio__input" value="Ghana">
                    <div class="radio__radio"></div>
                    Ghana
                </label>
            </div>
        ...
        <br/>
        <div class="count_que">
            <p>1 out of <strong>15</strong> countries.</p>
        </div>
      ...
      <div id="popup">
        <div class="row">
            <div class="col" style="text-align: center; margin: auto;">
                ...
                <!-- <span>- - - - - - - - - -->
                    <img src="continents/oceania.png" style="display: block; height: 200px; width: 100%; opacity: 0.3; z-index: 4;">
                <!--</span> -->
            </div>
    ...
    <script src="js/oceaniaJS.js"></script>
