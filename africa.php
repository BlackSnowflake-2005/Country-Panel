...
<head>
    ...
    <title>Africa | Country Panel</title>
...
<body>
      ...
      <section>
        <div class="main_quiz left">
          <div class="question row">
            <div class="col-lg-9">
                <h5>1. Algiers is the capital of?</h5>  
                </div>
                <div class="col-lg-3">
          ...
          <div class="options_list">
            <div class="option">
                <label for="Zambia" class="radio">
                    <input type="radio" name="list" id="Zambia" class="radio__input" value="Zambia">
            ...
            <div class="option">
                <label for="Algeria" class="radio">
                    <input type="radio" name="list" id="Algeria" class="radio__input" value="Algeria">
                    <div class="radio__radio"></div>
                    Algeria
                </label>
            </div>
            <div class="option">
                <label for="Tanzania" class="radio">
                    <input type="radio" name="list" id="Tanzania" class="radio__input" value="Tanzania">
                    <div class="radio__radio"></div>
                    Tanzania
                </label>
            </div>
        ...
        <br/>
        <div class="count_que">
            <p>1 out of <strong>54</strong> countries.</p>
        </div>
      ...
      <div id="popup">
        <div class="row">
            <div class="col" style="text-align: center; margin: auto;">
                ...
                <!-- <span>- - - - - - - - - -->
                    <img src="continents/africa.png" style="display: block; height: 200px; width: 100%; opacity: 0.3; z-index: 4;">
                <!--</span> -->
            </div>
    ...
    <script src="js/africaJS1.js"></script>
    <script src="js/africaJS2.js"></script>
