...
<head>
    ...
    <title>North America | Country Panel</title>
...
<body>
      ...
      <section>
        <div class="main_quiz left">
          <div class="question row">
            <div class="col-lg-9">
                <h5>1. Ottawa  is the capital of?</h5>  
                </div>
                <div class="col-lg-3">
          ...
          <div class="options_list">
            <div class="option">
                <label for="Montenegro" class="radio">
                    <input type="radio" name="list" id="Montenegro" class="radio__input" value="Montenegro">
                    <div class="radio__radio"></div>
                    Montenegro
                </label>
            </div>
            <div class="option">
                <label for="Haiti" class="radio">
                    <input type="radio" name="list" id="Haiti" class="radio__input" value="Haiti">
                    <div class="radio__radio"></div>
                    Haiti
                </label>
            </div>
            <div class="option">
                <label for="Canada" class="radio">
                    <input type="radio" name="list" id="Canada" class="radio__input" value="Canada">
                    <div class="radio__radio"></div>
                    Canada
                </label>
            </div>
            <div class="option">
                <label for="Cuba" class="radio">
                    <input type="radio" name="list" id="Cuba" class="radio__input" value="Cuba">
                    <div class="radio__radio"></div>
                    Cuba
                </label>
            </div>
        ...
        <br/>
        <div class="count_que">
            <p>1 out of <strong>23</strong> countries.</p>
        </div>
      ...
      <div id="popup">
        <div class="row">
            <div class="col" style="text-align: center; margin: auto;">
                ...
                <!-- <span>- - - - - - - - - -->
                    <img src="continents/northAmerica.png" style="display: block; height: 200px; width: 100%; opacity: 0.3; z-index: 4;">
                <!--</span> -->
            </div>
    ...
    <script src="js/northAmericaJS.js"></script>
