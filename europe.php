...
<head>
    ...
    <title>Europe | Country Panel</title>
...
<body>
      ...
      <section>
        <div class="main_quiz left">
          <div class="question row">
            <div class="col-lg-9">
                <h5>1. Tirana  is the capital of?</h5>  
                </div>
                <div class="col-lg-3">
          ...
          <div class="options_list">
            <div class="option">
                <label for="Albania" class="radio">
                    <input type="radio" name="list" id="Albania" class="radio__input" value="Albania">
                    <div class="radio__radio"></div>
                    Albania
                </label>
            </div>
            <div class="option">
                <label for="Philippiness" class="radio">
                    <input type="radio" name="list" id="Philippiness" class="radio__input" value="Philippiness">
                    <div class="radio__radio"></div>
                    Philippiness
                </label>
            </div>
            <div class="option">
                <label for="Uruguay" class="radio">
                    <input type="radio" name="list" id="Uruguay" class="radio__input" value="Uruguay">
                    <div class="radio__radio"></div>
                    Uruguay
                </label>
            </div>
            <div class="option">
                <label for="Ireland" class="radio">
                    <input type="radio" name="list" id="Ireland" class="radio__input" value="Ireland">
                    <div class="radio__radio"></div>
                    Ireland
                </label>
            </div>
        ...
        <br/>
        <div class="count_que">
            <p>1 out of <strong>44</strong> countries.</p>
        </div>
      ...
      <div id="popup">
        <div class="row">
            <div class="col" style="text-align: center; margin: auto;">
                ...
                <!-- <span>- - - - - - - - - -->
                    <img src="continents/europe.png" style="display: block; height: 200px; width: 100%; opacity: 0.3; z-index: 4;">
                <!--</span> -->
            </div>
    ...
    <script src="js/europeJS1.js"></script>
    <script src="js/europeJS2.js"></script>
