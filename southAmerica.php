...
<head>
    ...
    <title>South America | Country Panel</title>
...
<body>
      ...
      <section>
        <div class="main_quiz left">
          <div class="question row">
            <div class="col-lg-9">
                <h5>1. Buenos Aries is the capital of?</h5>  
                </div>
                <div class="col-lg-3">
          ...
          <div class="options_list">
            <div class="option">
                <label for="Argentina" class="radio">
                    <input type="radio" name="list" id="Argentina" class="radio__input" value="Argentina">
                    <div class="radio__radio"></div>
                    Argentina
                </label>
            </div>
            <div class="option">
                <label for="Colombia" class="radio">
                    <input type="radio" name="list" id="Colombia" class="radio__input" value="Colombia">
                    <div class="radio__radio"></div>
                    Colombia
                </label>
            </div>
        ...
        <br/>
        <div class="count_que">
            <p>1 out of <strong>12</strong> countries.</p>
        </div>
      ...
      <div id="popup">
        <div class="row">
            <div class="col" style="text-align: center; margin: auto;">
                ...
                <!-- <span>- - - - - - - - - -->
                    <img src="continents/southAmerica.png" style="display: block; height: 200px; width: 100%; opacity: 0.3; z-index: 4;">
                <!--</span> -->
            </div>
    ...
    <script src="js/southAmericaJS.js"></script>
